...
public class LabService {
    ...
    public static String connectAndExecuteCommand(String username, String password,
        ...
        try {
            ...
            session.setServerAliveInterval(2000); // Check if server is alive every 2 seconds
...
//                    tokens.add(tokenizer.nextToken());
                // TODO: Not tested, old impl above.
                    ...
                    String currentVersion = tokens.get(outputStringTokenized.length - 1); //??? Idk how did i fix that
