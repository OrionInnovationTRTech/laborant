...
public class RestAdminController {
    ...
    public ResponseEntity<String> addNewLab(@RequestBody String labName, String userName, String password, String host, String port) {
        return ResponseEntity.ok(adminService.addNewLab(labName, userName, password, host, Integer.valueOf(port)));
    }
